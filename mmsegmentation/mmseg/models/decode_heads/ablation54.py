...
class Ablation54(BaseDecodeHead):
    """
    Ablation 54 - Baseline + P Head (Fused) + P Head (Conditioned, HED)
    + P Head (Conditioned, SBD), with HED, SBD, and BAS supervisory 
    signals. Fusion present for P Head. See Holistically-Nested Edge 
