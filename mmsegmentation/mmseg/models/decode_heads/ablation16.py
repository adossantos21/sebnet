...
class Ablation16(BaseDecodeHead):
    """
    Ablation 16 - Baseline + P Head (Fused) + D Head (Fused), 
    with HED and BAS supervisory signals. Fusion present for
    P Head and D Head. This is the equivalent of PIDNet. See
    PIDNet at https://arxiv.org/pdf/2206.02066 for more
    details.
