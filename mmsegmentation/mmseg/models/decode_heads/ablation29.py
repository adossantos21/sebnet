...
class Ablation29(BaseDecodeHead):
    """
    Ablation 29 - Baseline + P Head (Conditioned) + Edge Head (Conditioned),
    with HED and BAS supervisory signals. No fusion. See 
    Holistically-Nested Edge Detection (HED) at 
    https://arxiv.org/pdf/1504.06375.pdf and Boundary-Awareness (BAS) at
