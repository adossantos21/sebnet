...
class Ablation46(BaseDecodeHead):
    """
    Ablation 46 - Baseline + P Head (Conditioned) + Edge Head (Conditioned, HED)
    + Edge Head (Conditioned, SBD) with HED, SBD, and BAS supervisory signals. 
    No fusion. See Holistically-Nested Edge Detection at 
