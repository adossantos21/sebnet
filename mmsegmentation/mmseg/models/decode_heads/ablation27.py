...
class Ablation27(BaseDecodeHead):
    """
    Ablation 27 - Baseline + P Head (Fused) + Edge Head (Conditioned, HED)
    + Edge Head (Fused, SBD), supervised with HED and SBD supervisory 
    signals. Fusion present for P Head and Edge Head. See 
    Holistically-Nested Edge Detection (HED) at 
    https://arxiv.org/pdf/1504.06375.pdf and Semantic Boundary Detection 
