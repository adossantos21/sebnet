...
class Ablation07(BaseDecodeHead):
    """
    Ablation 07 - Baseline + CASENet Head, conditioned with two 
    SBD supervisory signals for side5 and fuse. No fusion. See
