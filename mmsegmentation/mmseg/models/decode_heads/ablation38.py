...
class Ablation38(BaseDecodeHead):
    """
    Ablation 38 - Baseline + P Head (Conditioned) + Edge Head (Conditioned),
    with HED, SBD, and BAS supervisory signals. No fusion. See
    Holistically-Nested Edge Detection at https://arxiv.org/pdf/1504.06375,
    Semantic Boundary Detection at https://arxiv.org/pdf/1705.09759,
    and Boundary-Awareness at https://arxiv.org/pdf/2206.02066
    for more details.
