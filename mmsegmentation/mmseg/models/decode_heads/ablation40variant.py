...
class Ablation40(BaseDecodeHead):
    """
    Ablation 40 - Baseline + P Head (Fused) + Edge Head (Fused),
    ...
    we use SBD label to generate the BAS label in contrast to using
    HED label. Negligible difference in results.
