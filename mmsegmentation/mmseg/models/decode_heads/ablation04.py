...
class Ablation04(BaseDecodeHead):
    """
    Ablation 04 - Baseline + DFF Earlier Layers Head, conditioned 
    with two SBD supervisory signals for side5 and fuse. No 
    fusion. This head uses earlier  layers (lower-level) to 
    generate edge features. See https://arxiv.org/pdf/1902.09104 
    for more details.
