...
class Ablation42(BaseDecodeHead):
    """
    Ablation 42 - Baseline + P Head (Conditioned) + Edge Head (Conditioned, HED)
    + Edge Head (Conditioned, SBD), with HED and SBD supervisory signals. No 
    fusion. See Holistically-Nested Edge Detection (HED) at 
    https://arxiv.org/pdf/1504.06375.pdf and Semantic Boundary Detection (SBD) 
    at https://arxiv.org/pdf/1705.09759 for more details.
