...
class Ablation20Variant(BaseDecodeHead):
    """
    Ablation 20 Variant - Baseline + P Head (Fused) + Edge Head (Fused),
    ...
    https://arxiv.org/pdf/2206.02066 for more details. Variant since
    we use SBD logits to generate the BAS label in contrast to using
    HED logits. Negligible difference in results.
