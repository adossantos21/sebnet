...
class Ablation37(BaseDecodeHead):
    """
    Ablation 37 - Baseline + P Head (Fused) + Edge Head (Fused),
    supervised with HED and SBD supervisory signals. Fusion
    present for P Head and Edge Head. See Holistically-Nested
    Edge Detection (HED) at https://arxiv.org/pdf/1504.06375.pdf
    and Semantic Boundary Detection (SBD) at 
