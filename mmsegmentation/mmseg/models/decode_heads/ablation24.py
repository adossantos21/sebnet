...
class Ablation24(BaseDecodeHead):
    """
    Ablation 24 - Baseline + P Head (Fused) + Edge Head (Conditioned),
    conditioned with a HED supervisory signal. Fusion present for P
    Head. See Holistically-Nested Edge Detection (HED) at 
