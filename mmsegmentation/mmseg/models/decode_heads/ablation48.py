...
class Ablation48(BaseDecodeHead):
    """
    Ablation 48 - Baseline + P Head (Fused) + Edge Head (Fused, HED)
    + Edge Head (Conditioned, SBD), with HED, SBD, and BAS 
    supervisory signals. Fusion present in P Head and Edge Head. See 
    Holistically-Nested Edge Detection at 
