...
class Ablation32(BaseDecodeHead):
    """
    Ablation 32 - Baseline + P Head (Conditioned) + Edge Head (Conditioned),
    with SBD and BAS supervisory signals. No fusion. See Semantic Boundary 
