...
model = dict(
    ...
    decode_head=dict(
        type='BaselineDMultiLabelHeadEarlierLayers',     # The type of the classification head module.
...
train_pipeline = [
    ...
    dict(type='Mask2Edge', labelIds=list(range(0,19)), radius=4), # 0-19 for cityscapes classes
