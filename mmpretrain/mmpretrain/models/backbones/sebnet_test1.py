# SEBNet with one bottleneck followed by a basic block, as opposed to two bottlenecks.
...
class SEBNetTest1(BaseBackbone):
    """SEBNet backbone.
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(SEBNetTest1, self).__init__(init_cfg)
    ...
    def forward(self, x: Tensor) -> Union[Tensor, Tuple[Tensor]]:
        ...
        # stage 5
        x_5 = self.i_branch_layers[2](x_4) # (N, C=2048, H/64, W/64)
