# SEBNet with adaptive bottleneck
...
from mmpretrain.models.utils import AdaptiveBottleneck as Bottleneck
from mmpretrain.models.utils.basic_block import OptConfigType


@MODELS.register_module()
class SEBNetTest2(BaseBackbone):
    """SEBNet backbone.
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(SEBNetTest2, self).__init__(init_cfg)
